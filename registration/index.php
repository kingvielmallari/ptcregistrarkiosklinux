    <?php 
    session_start();
    include('documents/main_header/header.php'); 
    ?>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">
                            <center><i class="fa fa-fw fa-user-graduate"></i> <strong>Student Registration Form </strong></center>
                        </h2>
                            ...
                            <form id="validationform" name="student_form" data-parsley-validate="" novalidate="" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        ...
                                        ?>
                                        <input data-parsley-type="alphanum" type="text" name="studentID_no" required="" placeholder="" class="form-control" id="username" value="<?php echo $student_id; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        ...
                                        $student_id = isset($_SESSION['student_id']) ? $_SESSION['student_id'] : '';
                                        ?>
                                        <input data-parsley-type="alphanum" type="text" name="username" required="" placeholder="" class="form-control" id="username2" value="<?php echo $student_id; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
