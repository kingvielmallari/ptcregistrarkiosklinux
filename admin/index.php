    ...
    <body>
        <nav class="navbar navbar-dark bg-primary" style="background: rgb(17,10,134); background: linear-gradient(90deg, rgba(17,10,134,1) 0%, rgba(9,9,121,1) 28%, rgba(18,105,175,1) 100%);">
                ...
                <div class="card-body">
                    <form method="post" name="login_form">
                        <div class="form-group">
                            <h1 class="btn btn-dark container-fluid" href="#" role="button">MIS Staff</h1>
                        </div>
                        <br>
                        <div class="form-group">
