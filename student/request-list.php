                                                ...
                                                <div class="table-responsive">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        ...
                                                        if ($active_requests >= 3) {
                                                            echo '<div class="alert alert-warning m-0 w-100" role="alert" style="color:#cc0000">You have 3 pending requests. Please wait for them to be completed before submitting new requests.</div>';                        
                                                            echo '<script>document.querySelector("a[href=\'add-request.php\']").style.display = "none";</script>';
                                                        }
                                                        ?>
                                                    </div>
