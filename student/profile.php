                                        ...
                                        <div class="user-avatar-info">
                                            <div class="m-b-20">
                                                <div class="user-avatar-name">
                                                    <h2 class="mb-1">
                                                        <span id="firstName"><?= ucfirst($user['first_name']) . ' </span>' . ucfirst($user['middle_name']) . '<span id="lastName"> ' . ucfirst($user['last_name']); ?></span>
                                                    </h2>
                                                </div><br>
                                            </div>
                                            <div class="user-avatar-address">
                                                <p class="border-bottom pb-3">
                                                    ...
                                                    <span class="mb-2 d-xl-inline-block d-block ml-xl-4"><?= ucfirst($user['gender']); ?></span>
                                                </p>
                                                <p class="border-bottom pb-3">
